<template>
    <div class="w-full overflow-x-scroll lg:overflow-x-auto">
        <div class="min-w-table-dumps flex flex-col w-full">
            <dump-table-head></dump-table-head>
        </div>
    </div>
    <div v-for="dump in filtered" :key="dump.id" class="">
        <div class="flex flex-col w-full overflow-x-scroll lg:overflow-x-auto">
            <dump-table-row :data="dump"></dump-table-row>
        </div>
        <div class="w-full">
            <dump-table-information :data="dump" :volumes="additional.volumes"></dump-table-information>
        </div>
    </div>
...
import DumpTableHead from "./DumpTableHead";
import DumpTableRow from "./DumpTableRow";
import DumpTableInformation from "./DumpTableInformation";
