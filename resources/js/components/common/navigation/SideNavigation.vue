              ...
              <ul class="flex flex-col border-l-2 border-green-500 border-solid gap-2 w-full">
                <li class="flex flex-col justify-center items-start w-full">
                  <inertia-link
                    ...
                    class="flex dark:text-white colors-transition hover:text-gray-600 pl-4 dark:hover:text-gray-300
              ...
              <ul class="flex flex-col border-l-2 border-blue-500 border-solid gap-1 w-full">
                ...
                >
                  <inertia-link
                    ...
                    class="flex dark:text-white pl-4 colors-transition hover:text-gray-600dark:hover:text-gray-300
                    font-semibold w-full py-1"
                    tabindex="0"
                  >
                    {{ municipality.name }}
                  </inertia-link>
